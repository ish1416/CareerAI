...
async function main() {
  ...
  const existingCount = await prisma.codingQuestion.count();
  if (existingCount > 0) {
    console.log(`✅ Database already has ${existingCount} questions`);
    console.log('   Run "npx prisma studio" to view them');
    return;
  }
...
Each time you can either climb 1 or 2 steps. In how many distinct ways can you climb to the top?`,
  ...
  console.log(`\n✅ Successfully seeded ${questions.length} coding questions!`);
  console.log('\n📊 Summary:');
  console.log(`   - Companies: Google, Amazon, Facebook, Microsoft, Apple`);
  console.log(`   - Topics: Arrays, Strings, Linked Lists, Trees, Dynamic Programming`);
  console.log(`   - Difficulty: All Easy (great for beginners)`);
  console.log(`   - Languages: JavaScript, Python, Java, C++`);
  console.log('\n🚀 Ready to use! Visit /coding-questions in your app');
}
