...
router.post('/analyze', requireAuth, aiLimiter, enforcePlanLimits('analyze'), analyze);
router.post('/rewrite', requireAuth, aiLimiter, enforcePlanLimits('rewrite'), rewrite);
